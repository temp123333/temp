...
export const hiddenTrails: Trail[] = [
  {
    ...
    description: 'The Annapurna Circuit is one of the most diverse and spectacular treks in Nepal, offering an incredible journey through dramatic deep valleys and high mountains. This trek encircles the Annapurna massif, crossing Thorong La Pass (5,416m), and showcases the region's cultural and geographical diversity. You'll pass through subtropical jungle, arid cliffs reminiscent of Tibet, and the world's deepest gorge - the Kali Gandaki. The trail takes you through traditional Hindu villages in the lower regions and Buddhist settlements in the upper portions, offering unique cultural insights.',
